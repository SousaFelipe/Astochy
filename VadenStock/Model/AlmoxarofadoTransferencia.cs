...
{
    public class AlmoxarofadoTransferencia : Connection
    {
        public static AlmoxarofadoTransferencia Model { get { return new AlmoxarofadoTransferencia(); } }



        public AlmoxarofadoTransferencia() : base("almoxarifado_transferencias") { }



        public override AlmoxarofadoTransferencia Where(string column, object operOrValue, object? value = null)
        {
            return (AlmoxarofadoTransferencia)base.Where(column, operOrValue, value);
        }
